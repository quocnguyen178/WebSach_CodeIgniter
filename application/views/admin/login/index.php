...
<body class="nobg loginPage" style="min-height:100%;">
	...
	<div class="loginWrapper" style="top:45%;">
	    ...
	    <div class="widget" id="admin_login" style="height:auto; margin:auto;">
	        <div class="title"><img src="<?php echo public_url('admin/') ?>images/icons/dark/laptop.png" alt="Đăng nhập" class="titleIcon" />
	        	<h6>Đăng nhập</h6>
	        </div>
	        ...
	        <form class="form" id="form" action="" method="post">
	           <fieldset>
	                ...
	                <div class="loginControl">
	                	<div style="color:red; text-align: center; margin-top: -10px; "><?php echo form_error('login'); ?><div>
