...
<div class="oneTwo">
	<div class="widget">
		<div class="title">
			<img src="<?php echo public_url('admin/') ?>images/icons/dark/money.png" class="titleIcon" alt="Doanh số" />
			<h6>Doanh số</h6>
		</div>
...
<div class="oneTwo">
	<div class="widget">
		<div class="title">
			<img src="<?php echo public_url('admin/') ?>images/icons/dark/users.png" class="titleIcon" alt="Thông kê dữ liệu" />
	...
	<div class="widget">
		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
			...
			<thead>
				<tr>
					<td style="width:10px;"><img src="<?php echo public_url('admin/') ?>images/icons/tableArrows.png" alt="Danh sách Giao dịch" /></td>
				...
				<tr>
					<td colspan="8">
						 <div class="list_action itemActions">
								<a href="" id="submit" class="button blueB" url="admin/tran/del_all.html">
			...
			<tbody class="list_item">
					...
					<td class="textC">
							<a href="" class="lightbox">
								<img src="<?php echo public_url('admin/') ?>images/icons/color/view.png" alt="Chi tiết" />
							</a>
